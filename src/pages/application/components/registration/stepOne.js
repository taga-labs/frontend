                        ...
                        <div className="container form onboarding">
                            <form onSubmit={this.onSubmit}>
                                ...
                                <div ref={this.identifierRef} onFocus={() => {this.setState({focus: 1})}} className={(this.state.focus == 1) ? "input container selected" : "input container"}>
                                    ...
                                    <input onFocus={() => { this.onFocus(1) }} value={ (window.sessionStorage.getItem("getStartedIdentifier") != undefined) ? this.state.identifier : null} onChange={this.onIdentifierChange} className="input create" placeholder="enter an identifier..." />
                                    <div className={"icon container input"}>
